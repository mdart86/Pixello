...
export const Input = styled.input`
    ...
    ${props => props.createPost || props.filter || props.savecomment ? "height: 35px; border-radius: 5px; font-family: 'Pacifico', cursive;" : "border-bottom: 1px solid var(--white);"}
    ...
    ${props => props.savecomment ? "margin: 5px auto; width: 60px;" : null}
    &:focus {
        outline: none;
        border: 3px solid var(--dark-pink);
    }
    &:hover {
        ${props => props.createPost || props.filter || props.savecomment ? "opacity: 0.7;" : null}
    }
`