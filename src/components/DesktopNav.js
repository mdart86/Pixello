        ...
        return (
            <BoxDesktopNavNoPlus>
                ...
                <IconsContainer desktop="true">
                    {window.location.pathname === "/home" ? <Link to={`/posts/${category}`}><IconDesktopNav src={category} alt="search by category icon"/></Link> : <Link to="/home"><IconDesktopNav src={home} alt="home page icon"/></Link>}
