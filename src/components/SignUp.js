        ...
        <>
            ...
            <BackgroundBox signup="true">
                <Form signup="true" onSubmit={submitFormData}>
                    <Input required minLength="3" maxLength="30" signup="true" username="true" type="text" id="username" placeholder="Username" value={formData.username} onChange={handleFormData}/>
                    <Input required minLength="3" maxLength="50" signup="true" type="email" id="email" placeholder="Email" value={formData.email} onChange={handleFormData}/>
                    ...
                    <Textarea required minLength="3" maxLength="200" signup="true" type="text" id="bio" placeholder="Your bio" value={formData.bio} onChange={handleFormData}/>
                    <p>Your avatar:</p>
